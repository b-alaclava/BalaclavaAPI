package com.example.Plugins.BCooker;


import com.example.BalaclavaAPI.InteractionUtility.BankUtility;
...
import com.example.EthanApi.Collections.*;
...
@PluginDescriptor(
        name = "<html><font color=\"#6DF030\">B.</font> Cooker</html>",
